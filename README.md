...
- a token is given to a client after authentication so it can have the required authorization to access the server data

2. What steps can you take in your web apps to keep your data secure?

- you can request a logim

3. Describe how web servers work.

- web servers work by sending data to the client once it has been requested
